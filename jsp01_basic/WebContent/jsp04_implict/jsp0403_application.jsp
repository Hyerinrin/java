...
<!--  
   ...
   2. getInitParameterName() : 웹애플리케이션 초기화 파라미터 이름목록을 리턴
...
<body>
	 ...
	 서블릿 규약 메이저 정보 : <%= application.getMajorVersion() %><br>
	 서블릿 규약 마이너 정보 : <%= application.getMinorVersion() %><br>
	 
	 
	 <h4>로그메세지 기록</h4>
	 <%
	 	application.log("로그메시지를 기록합니다.....");
	 	log("로그 메시지 기록 - log");
	 %>
